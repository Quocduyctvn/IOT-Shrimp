...
namespace EcoShrimp.Data.Migrations
{
    ...
    [Migration("20250413135639_ud-tble-sensorToEnviIdx")]
    partial class udtblesensorToEnviIdx
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcoShrimp.Data.Entities.AppEnviIndex", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("app_env_idx", (string)null);
                });
            ...
            modelBuilder.Entity("EcoShrimp.Data.Entities.AppProEnviIndex", b =>
                {
                    ...
                    b.HasKey("ProId", "SensorId");

                    b.HasIndex("SensorId");

                    b.ToTable("app_prod_env_idx", (string)null);
                });
            ...
            modelBuilder.Entity("EcoShrimp.Data.Entities.AppUsers", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdRole = 1,
                            Name = "Quốc Duy",
                            Pass = "$2a$10$RHPsLg.5lEQkjKw8FJnbSOCrmnmxSqZUpmnMD.yAn0L2W2xntMsFK",
                            Phone = "0901007221",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("EcoShrimp.Data.Entities.AppProEnviIndex", b =>
                {
                    b.HasOne("EcoShrimp.Data.Entities.AppProducts", "appProducts")
                        .WithMany("appProEnviIndex")
                        .HasForeignKey("ProId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EcoShrimp.Data.Entities.AppEnviIndex", "appEnviIndex")
                        .WithMany("appProEnviIndex")
                        .HasForeignKey("SensorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("appEnviIndex");
