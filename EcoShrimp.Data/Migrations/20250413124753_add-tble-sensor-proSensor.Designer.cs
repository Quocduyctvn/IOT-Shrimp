...
namespace EcoShrimp.Data.Migrations
{
    ...
    [Migration("20250413124753_add-tble-sensor-proSensor")]
    partial class addtblesensorproSensor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcoShrimp.Data.Entities.AppProSensors", b =>
                {
                    ...
                    b.ToTable("app_product_sensor", (string)null);
                });
            ...
            modelBuilder.Entity("EcoShrimp.Data.Entities.AppSensors", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("app_sensors", (string)null);
                });
            ...
            modelBuilder.Entity("EcoShrimp.Data.Entities.AppUsers", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdRole = 1,
                            Name = "Quốc Duy",
                            Pass = "$2a$10$3n.KcjWwX0uU6pl0m3cPqeDwrncaNFAlyDVfWpYOWubHbBS.S0K8q",
                            Phone = "0901007221",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("EcoShrimp.Data.Entities.AppProSensors", b =>
                {
                    b.HasOne("EcoShrimp.Data.Entities.AppProducts", "appProducts")
                        .WithMany("appProSensors")
                        .HasForeignKey("ProId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EcoShrimp.Data.Entities.AppSensors", "appSensors")
                        .WithMany("appProSensors")
