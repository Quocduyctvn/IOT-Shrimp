...
namespace EcoShrimp.Data.Migrations
{
    ...
    [Migration("20250414121117_add-tble-threshold")]
    partial class addtblethreshold
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcoShrimp.Data.Entities.AppThresholds", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("app_threshold", (string)null);
                });
            ...
            modelBuilder.Entity("EcoShrimp.Data.Entities.AppUsers", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdRole = 1,
                            Name = "Quốc Duy",
                            Pass = "$2a$10$jNT0xxBr4zJ6sdql6f6eNOZfwA0k4dxQ4FLN2LrB5lXVByap9.Bym",
                            Phone = "0901007221",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("EcoShrimp.Data.Entities.AppThresholds", b =>
                {
                    b.HasOne("EcoShrimp.Data.Entities.AppFarms", "appFarms")
                        .WithMany("appThresholds")
                        .HasForeignKey("IdFarm")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("appFarms");
                });
